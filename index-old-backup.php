<?php
/**
 * 🏪 MultiTienda Pro - Sistema Completo de E-commerce Multi-Tenant
 * Plataforma profesional de múltiples tiendas
 */
...
if ($path === '' || $path === '/') {
    if (!auth()->isLoggedIn()) {
        // Mostrar landing page profesional para visitantes
